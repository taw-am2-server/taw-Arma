module.exports = {
  ...
  "additionalConfigurationOptions": "kickDuplicate=1;\nallowedVoteCmds[] = {};\nallowedLoadFileExtensions[]={\"b64\",\"sqf\",\"cpp\",\"hpp\"};\nallowedPreprocessFileExtensions[]={\"b64\",\"sqf\",\"cpp\",\"hpp\"};\ndoubleIdDetected=\"private _message = format['Player with ID %1 kicked for duplicate ID', _this select 0]; diag_log _message; _message remoteExec ['systemChat']; kick (_this select 0);\";\nonHackedData=\"private _message = format['Player with ID %1 kicked for having hacked data', _this select 0]; diag_log _message; _message remoteExec ['systemChat']; kick (_this select 0);\";\nonDifferentData=\"private _message = format['Player with ID %1 kicked for having different data in file %2', _this select 0, _this select 1]; diag_log _message; _message remoteExec ['systemChat']; kick (_this select 0);\";\nonUnsignedData=\"private _message = format['Player with ID %1 kicked for having unsigned data in file %2', _this select 0, _this select 1]; diag_log _message; _message remoteExec ['systemChat']; kick (_this select 0);\";",
