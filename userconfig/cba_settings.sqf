...
force force ace_common_checkPBOsWhitelist = "['jsrs_soundmod_complete_edition_soundfiles','ZEI','jsrs_soundmod_complete_edition','jsrs_soundmod_boats','jsrs_soundmod_sonic_cracks','jsrs_soundmod_weapons','jsrs_soundmod_environment','jsrs_soundmod_explosions','jsrs_soundmod_framework','jsrs_soundmod_landvehicles','jsrs_soundmod_movement','jsrs_soundmod_bullethits','jsrs_soundmod_helicopters','jsrs_soundmod_rhs_afrf_weapons','jsrs_soundmod_cfg_rhs_afrf_weapons','jsrs_soundmod_cfg_rhs_afrf_vehicles','jsrs_soundmod_cfg_rhs_afrf_air_vehicles','jsrs_soundmod_rhs_gref_weapons','jsrs_soundmod_rhs_usf_weapons','jsrs_soundmod_cfg_rhs_usf_weapons','jsrs_soundmod_cfg_rhs_usf_vehicles','jsrs_soundmod_cfg_rhs_usf_air_vehicles']"
...
// ACE XENO
ace_xeno_taru_pod_mod_menu_molette = true;
...
force force RydFFE_Safe = 150;
force force RydFFE_ShellView = false;

// Goko Ballistic Impact
force force gokobi_var_AllowedCaliber = 2;
force force gokobi_var_debug = false;
force force gokobi_var_onoffswitch = false;
...
// LAxemanns Suppress
force force L_Suppress_buildup = 0.3;
...
force force L_Suppress_intensity = 0.3;
force force L_Suppress_playerSwabEnabled = true;
force force L_Suppress_recovery = 0.7;
...
// NMAB Settings
force force NMAB_setting_particlesEnabled = false;
...
// VCOM DRIVING
force force VCM_DRIVERLIMIT = 5;
force force VCM_DrivingActivated = true;
force force VCM_DrivingDelay = 1;
force force VCM_DrivingDist = 25;
...
force force VCM_STATICARMT = 360;
force force VCM_StealVeh = false;
force force VCM_WARNDELAY = 180;
force force VCM_WARNDIST = 750;

// VCOM SKILL SETTINGS
force force VCM_AISKILL_AIMINGACCURACY_E = 0.2;
force force VCM_AISKILL_AIMINGACCURACY_R = 0.2;
force force VCM_AISKILL_AIMINGACCURACY_W = 0.2;
force force VCM_AISKILL_AIMINGSHAKE_E = 0.2;
force force VCM_AISKILL_AIMINGSHAKE_R = 0.2;
force force VCM_AISKILL_AIMINGSHAKE_W = 0.2;
force force VCM_AISKILL_AIMINGSPEED_E = 0.2;
force force VCM_AISKILL_AIMINGSPEED_R = 0.2;
force force VCM_AISKILL_AIMINGSPEED_W = 0.2;
